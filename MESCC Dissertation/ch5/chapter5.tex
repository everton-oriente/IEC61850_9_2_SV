...
\begin{lstlisting}[breaklines=true, caption={Asynchronous function process frame() that processes a received SV.}, label={lst:AlgorithmLogicandStructure}]
...
\begin{lstlisting}[breaklines=true, caption={Asynchronous function async fn valid error percentage() that processes the buffers and calculate the error.}, label={lst:DecisionMaking}]
